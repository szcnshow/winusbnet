    ...
    public class USBDevice : IDisposable
    {
        ...
        private void CheckControlParams(int value, int index, byte[] buffer, int length)
        {
            if (value < ushort.MinValue || value > ushort.MaxValue)
                throw new ArgumentOutOfRangeException("value", "Value parameter out of range.");
            ...
            if (length > buffer.Length)
                throw new ArgumentOutOfRangeException("length", "Length parameter is larger than the size of the buffer.");
        ...
        public int ControlPipeTimeout
        {
            ...
            {
                if (value < 0)
                    throw new ArgumentOutOfRangeException("value", "Control pipe timeout cannot be negative.");
